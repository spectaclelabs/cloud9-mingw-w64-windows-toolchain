...
enum opt_code
{
  ...
  OPT_municode = 1148,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1149,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1150,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1151,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1152,                    /* -mvzeroupper */
  OPT_mwin32 = 1153,                         /* -mwin32 */
  OPT_mwindows = 1154,                       /* -mwindows */
  OPT_mx32 = 1155,                           /* -mx32 */
  OPT_mxop = 1156,                           /* -mxop */
  OPT_mxsave = 1157,                         /* -mxsave */
  OPT_mxsaveopt = 1158,                      /* -mxsaveopt */
  OPT_n = 1159,                              /* -n */
  OPT_no_canonical_prefixes = 1160,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1161,              /* -no-integrated-cpp */
  OPT_no_pthread = 1162,                     /* -no-pthread */
  OPT_nocpp = 1163,                          /* -nocpp */
  OPT_nodefaultlibs = 1164,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1165,                   /* -nostartfiles */
  OPT_nostdinc = 1166,                       /* -nostdinc */
  OPT_nostdinc__ = 1167,                     /* -nostdinc++ */
  OPT_nostdlib = 1168,                       /* -nostdlib */
  OPT_o = 1169,                              /* -o */
  OPT_p = 1170,                              /* -p */
  OPT_pass_exit_codes = 1171,                /* -pass-exit-codes */
  /* OPT_pedantic = 1172, */                 /* -pedantic */
  OPT_pedantic_errors = 1173,                /* -pedantic-errors */
  OPT_pg = 1174,                             /* -pg */
  OPT_pie = 1175,                            /* -pie */
  OPT_pipe = 1176,                           /* -pipe */
  OPT_posix = 1177,                          /* -posix */
  OPT_print_file_name_ = 1178,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1179,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1180,          /* -print-multi-directory */
  OPT_print_multi_lib = 1181,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1182,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1183,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1184,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1185,               /* -print-prog-name= */
  OPT_print_search_dirs = 1186,              /* -print-search-dirs */
  OPT_print_sysroot = 1187,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1188,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1189,                        /* -pthread */
  OPT_quiet = 1190,                          /* -quiet */
  OPT_r = 1191,                              /* -r */
  OPT_remap = 1192,                          /* -remap */
  OPT_s = 1193,                              /* -s */
  OPT_s_bc_abi = 1194,                       /* -s-bc-abi */
  OPT_save_temps = 1195,                     /* -save-temps */
  OPT_save_temps_ = 1196,                    /* -save-temps= */
  OPT_shared = 1197,                         /* -shared */
  OPT_shared_libgcc = 1198,                  /* -shared-libgcc */
  /* OPT_specs = 1199, */                    /* -specs */
  OPT_specs_ = 1200,                         /* -specs= */
  OPT_static = 1201,                         /* -static */
  OPT_static_libasan = 1202,                 /* -static-libasan */
  OPT_static_libgcc = 1203,                  /* -static-libgcc */
  OPT_static_libgcj = 1204,                  /* -static-libgcj */
  OPT_static_libgfortran = 1205,             /* -static-libgfortran */
  OPT_static_libgo = 1206,                   /* -static-libgo */
  ...
  OPT_std_c__1y = 1212,                      /* -std=c++1y */
  OPT_std_c__98 = 1213,                      /* -std=c++98 */
  OPT_std_c11 = 1214,                        /* -std=c11 */
  /* OPT_std_c1x = 1215, */                  /* -std=c1x */
  /* OPT_std_c89 = 1216, */                  /* -std=c89 */
  OPT_std_c90 = 1217,                        /* -std=c90 */
  OPT_std_c99 = 1218,                        /* -std=c99 */
  /* OPT_std_c9x = 1219, */                  /* -std=c9x */
  OPT_std_f2003 = 1220,                      /* -std=f2003 */
  OPT_std_f2008 = 1221,                      /* -std=f2008 */
  OPT_std_f2008ts = 1222,                    /* -std=f2008ts */
  OPT_std_f95 = 1223,                        /* -std=f95 */
  OPT_std_gnu = 1224,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1225, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1226, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1227,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1228,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1229,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1230,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1231, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1232, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1233,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1234,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1235, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1236, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1237,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1238, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1239, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1240, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1241,                     /* -std=legacy */
  OPT_symbolic = 1242,                       /* -symbolic */
  OPT_t = 1243,                              /* -t */
  OPT_time = 1244,                           /* -time */
  OPT_time_ = 1245,                          /* -time= */
  OPT_traditional = 1246,                    /* -traditional */
  OPT_traditional_cpp = 1247,                /* -traditional-cpp */
  OPT_trigraphs = 1248,                      /* -trigraphs */
  OPT_u = 1249,                              /* -u */
  OPT_undef = 1250,                          /* -undef */
  OPT_v = 1251,                              /* -v */
  OPT_version = 1252,                        /* -version */
  OPT_w = 1253,                              /* -w */
  OPT_wrapper = 1254,                        /* -wrapper */
  OPT_x = 1255,                              /* -x */
  OPT_z = 1256,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
